...
CREATE TABLE IF NOT EXISTS `class_teachers` (
  ...
  `teacher_id` INT NOT NULL COMMENT 'FK → users(userNo)',
  `class_id` INT NOT NULL COMMENT 'FK → classes(classID)',
  `academic_year_id` INT NOT NULL COMMENT 'FK → academic_years(id)',
