...
-- 1. Buses
ALTER TABLE `buses` ADD COLUMN `school_id` INT UNSIGNED NOT NULL DEFAULT 1 AFTER `current_mileage`;
...
-- 2. Fuel Vouchers
ALTER TABLE `fuel_vouchers` ADD COLUMN `school_id` INT UNSIGNED NOT NULL DEFAULT 1;
...
-- 3. Fuel Invoices
ALTER TABLE `fuel_invoices` ADD COLUMN `school_id` INT UNSIGNED NOT NULL DEFAULT 1;
...
-- 4. Service Records
ALTER TABLE `service_records` ADD COLUMN `school_id` INT UNSIGNED NOT NULL DEFAULT 1;
...
-- 5. Oil Records
ALTER TABLE `oil_records` ADD COLUMN `school_id` INT UNSIGNED NOT NULL DEFAULT 1;
...
-- 6. Item Stock
ALTER TABLE `item_stock` ADD COLUMN `school_id` INT UNSIGNED NOT NULL DEFAULT 1;
...
-- 7. Stock Movements
ALTER TABLE `stock_movements` ADD COLUMN `school_id` INT UNSIGNED NOT NULL DEFAULT 1;
...
-- 8. Uniform Receipts
ALTER TABLE `uniform_receipts` ADD COLUMN `school_id` INT UNSIGNED NOT NULL DEFAULT 1;
...
ALTER TABLE `uniform_prices` ADD COLUMN IF NOT EXISTS `school_id` INT UNSIGNED NOT NULL DEFAULT 1;
...
-- 10. Academic Years
ALTER TABLE `academic_years` ADD COLUMN IF NOT EXISTS `school_id` INT UNSIGNED NOT NULL DEFAULT 1;
ALTER TABLE `academic_years` ADD KEY IF NOT EXISTS `idx_academic_years_school_id` (`school_id`);

-- 11. Fee Ledger
ALTER TABLE `fee_ledger` ADD COLUMN IF NOT EXISTS `school_id` INT UNSIGNED NOT NULL DEFAULT 1;
ALTER TABLE `fee_ledger` ADD KEY IF NOT EXISTS `idx_fee_ledger_school_id` (`school_id`);

-- 12. Fodebit (legacy finance table)
ALTER TABLE `fodebit` ADD COLUMN `school_id` INT UNSIGNED NOT NULL DEFAULT 1;
