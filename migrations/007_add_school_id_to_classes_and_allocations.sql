...
-- -------------------------------------------------------------------------
ALTER TABLE `classes`
  ADD COLUMN `school_id` INT UNSIGNED NOT NULL DEFAULT 1 AFTER `classID`;
...
ALTER TABLE `class_allocation`
  ADD COLUMN `school_id` INT UNSIGNED NOT NULL DEFAULT 1 AFTER `academic_year_id`;
...
ALTER TABLE `classallocation`
  ADD COLUMN `school_id` INT UNSIGNED NOT NULL DEFAULT 1 AFTER `feegrp`;
