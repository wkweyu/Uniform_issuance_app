...
| Repository regression | Non-Finance test execution | Unrelated attendance, tenancy, and platform tests execute with their own required dependencies and current UI assertions. | `507 passed, 18 failed`; failures are outside Finance RC1 and recorded as TD-005. | DEFERRED OUT OF SCOPE | Automated suite | 2026-08-08 |
